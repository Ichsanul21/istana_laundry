...
<div {{ $attributes->whereDoesntStartWith('wire:model')->except(['class']) }}>
    ...
    <input type="{{ $type }}"
           ...
           @class([
               'h-11 w-full rounded-lg border px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3 transition-colors duration-200',
